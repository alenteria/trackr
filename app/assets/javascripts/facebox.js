...
(function($) {
 /**
   ...
   */
   $.facebox = function(data, klass, isOnload) { 
    ...
    else if (data.ajax) fillFaceboxFromAjax(data.ajax) 
 ...
 /**
   ...
   */
  $.facebox.settings = {
    loading_image : '/icons/loading.gif',
    close_image   : '/icons/closelabedl.png',
  ...
  <div id="facebox" style="display:none;"> \
    ...
    <div class="popup"> \
      <table> \
        <tbody> \
          <tr> \
            <td class="tl"/><td class="n"/><td class="tr"/> \
          </tr> \
          <tr> \
            <td class="w"/> \
            <td class="body"> \
              <a href="#" class="close"> \
                  <img src="/icons/closelabel.png" title="Close" class="close_image" /> \
                </a> \
          ...
          <tr> \
            <td class="bl"/><td class="s"/><td class="br"/> \
          </tr> \
        </tbody> \
      </table> \
    </div> \
...
/**
  ...
  */
  function facebox_reveal(data, klass, extra_setup) {
    ...
    $("#facebox .overlay").css('opacity', '0.3').show();
  }
  ...
  */
  ...
  function getPageHeight() {
    ...
    return windowHeight
     ...
     jQuery(document).ready(function($) { 
    $("a[rel*=facebox]").facebox(); 
    //$.facebox("#messageTable","facebox",true); 
}) 